...
import java.io.*;
import java.util.*;
class Senior60Plus extends RegisterSwimmer{
    int price;

    public Senior60Plus(String name, int id, String address, int phoneNumber, String email,
    ...
    public static void registration60Plus(){
        ...
        Senior60Plus newMember = new Senior60Plus(name, id, address, number, mail, gender, payment, birtdate, price);
